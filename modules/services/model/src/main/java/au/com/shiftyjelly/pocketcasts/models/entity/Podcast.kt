...
data class Podcast(
    ...
    @ColumnInfo(name = "jusskipit_enabled", defaultValue = "0") var isJusskipitEnabled: Boolean = false,
    @ColumnInfo(name = "jusskipit_enabled_modified", defaultValue = "0") var isJusskipitEnabledModified: Boolean = false,
